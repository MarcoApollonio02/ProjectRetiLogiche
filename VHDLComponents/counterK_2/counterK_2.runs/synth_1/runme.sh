...
HD_PWD='C:/Users/marco/VivadoProjects/counterK_2/counterK_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CounterK.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CounterK.tcl
