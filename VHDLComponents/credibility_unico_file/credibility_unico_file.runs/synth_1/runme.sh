...
HD_PWD='C:/Users/giaco/projects/Reti Logiche/credibility_unico_file/credibility_unico_file.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CredibilityT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CredibilityT.tcl
